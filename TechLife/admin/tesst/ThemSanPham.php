...
<head>
    ...
    <meta charset="utf-8">
    <meta name="keywords" content="Cấu hình chi tiết">
    ...
    <link rel="stylesheet" href="ThemSanPham.css" media="screen">
    ...
    <meta property="og:title" content="ThemSanPham">
    ...
    <div class="u-clearfix u-sheet u-sheet-1">
        ...
        <div class="u-form u-form-1">
            <form method="POST" action="DAO.php"  style="padding: 15px;"  name="form">
                    <input type="text" placeholder="ID máy" id="name-7800" name="name" value="<?php echo date("d").date("hs")?>" class="u-border-1 u-border-grey-30 u-input u-input-rectangle" >
                    <input type="text" placeholder="Tên máy" id="name-7800" name="name-1" class="u-border-1 u-border-grey-30 u-input u-input-rectangle">
                    <input type="text" placeholder="Hãng" id="name-7800" name="name-2" class="u-border-1 u-border-grey-30 u-input u-input-rectangle">
                    <input type="text" placeholder="Số tiền" id="name-7800" name="name-3" class="u-border-1 u-border-grey-30 u-input u-input-rectangle" >
                    <input type="text" placeholder="Hình ảnh" id="name-7800" name="name-4" class="u-border-1 u-border-grey-30 u-input u-input-rectangle" >
                    <input type="text" placeholder="Hệ điều hành" id="name-6797" name="name-5" class="u-border-1 u-border-grey-30 u-input u-input-rectangle" >
                    <input type="text" placeholder="CPU" id="name-2af2" name="name-6" class="u-border-1 u-border-grey-30 u-input u-input-rectangle" >
                    <input type="text" placeholder="RAM" id="name-4f98" name="name-7" class="u-border-1 u-border-grey-30 u-input u-input-rectangle" >
                    <input type="text" placeholder="Card đồ họa" id="name-772e" name="name-8" class="u-border-1 u-border-grey-30 u-input u-input-rectangle" >
                    <input type="text" placeholder="HDD" id="name-def0" name="name-9" class="u-border-1 u-border-grey-30 u-input u-input-rectangle" >
                    <input type="text" placeholder="SSD" id="name-9105" name="name-10" class="u-border-1 u-border-grey-30 u-input u-input-rectangle" >
                    <input type="text" placeholder="Màn hình" id="name-4eea" name="name-11" class="u-border-1 u-border-grey-30 u-input u-input-rectangle" >
                    <input type="text" placeholder="LAN" id="name-7d8c" name="name-12" class="u-border-1 u-border-grey-30 u-input u-input-rectangle" >
                    <input type="text" placeholder="WIFI" id="name-22c4" name="name-13" class="u-border-1 u-border-grey-30 u-input u-input-rectangle" >
                    <input type="text" placeholder="Các cổng kết nối" id="name-ca16" name="name-14" class="u-border-1 u-border-grey-30 u-input u-input-rectangle" >
                    <input type="text" placeholder="Bàn phím" id="name-7269" name="name-15" class="u-border-1 u-border-grey-30 u-input u-input-rectangle" >
                    <input type="text" placeholder="Dung lượng pin" id="name-bb51" name="name-16" class="u-border-1 u-border-grey-30 u-input u-input-rectangle" >
                    <input type="text" placeholder="Cân nặng" id="name-86ac" name="name-17" class="u-border-1 u-border-grey-30 u-input u-input-rectangle" >
                    <input type="text" placeholder="Ổ đĩa quang" id="name-7800" name="name-18" class="u-border-1 u-border-grey-30 u-input u-input-rectangle" >
                    <br>
                    <input type="submit" name="submit" id="submit" value="Tạo sản phẩm">
            </form>
        </div>
    </div>
</section>
