...
//        }
    ...
    function getDetailProduct($Id){
        ...
        $curl = curl_init();
        curl_setopt_array($curl, array(
            CURLOPT_URL => "https://taeiblog.000webhostapp.com/RestFullApi/Data/Data/getDetail.php?Id=".$Id,
            CURLOPT_RETURNTRANSFER => true,
            CURLOPT_TIMEOUT => 30,
            CURLOPT_HTTP_VERSION => CURL_HTTP_VERSION_1_1,
            CURLOPT_CUSTOMREQUEST => "GET",
...
//        }
        ...
        $_SESSION["listDetailProduct"] = $listAllProduct;
    }
...
//        header('location: ThemSanPham.php');
        $_SESSION['warning'] = "Không thêm mới được, có lỗi xảy ra, vui lòng kiểm tra lại";
    }
}
